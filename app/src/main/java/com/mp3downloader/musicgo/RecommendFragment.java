...
public class RecommendFragment extends SupportFragment {
    ...
    private CommonAdapter mCommonAdapter = new CommonAdapter<BaseModel>(App.sContext,
    ...
    private void initView(View view) {
        ...
        mSwipeRefreshLayout.setColorSchemeColors(ContextCompat.getColor(App.sContext, R.color.colorAccent));
    ...
    private void showErrorView() {
        ...
        Drawable drawable = ContextCompat.getDrawable(App.sContext, R.drawable.ic_error);
    ...
    private void showEmptyView() {
        mRecyclerView.setVisibility(View.GONE);
        mStatusTV.setVisibility(View.VISIBLE);
        Drawable drawable = ContextCompat.getDrawable(App.sContext, R.drawable.ic_empty);
        drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
        mStatusTV.setCompoundDrawables(null, drawable,
                null, null);
    ...
    private void initData() {
        ...
        mLoadTask = new AsyncTask<Void, Void, List<BaseModel>>() {
            ...
            protected List<BaseModel> doInBackground(Void... Void) {
                ...
                if (mMusicApi != null) {
                    return mMusicApi.getRecommondMusic(App.sContext);
                }
                return null;
            }
